...
@section('content')
 ...
 <h2>About Us</h2>
 <p>Routine and repetitive polls require a sophisticated and structured approach to the execution of the poll and the management and reporting of the poll response data. Designed well, robust and repeatable automated processes can take the grind out of handling survey datasets – improving quality and reducing cost on a daily basis. Poll Management System (PMS) is a web-enabled application which empowers the development, distributing and analysis of poll forms to improve communication, process management, and decision support across the organization. 
