...
@section('content')
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url('assets(a)/images/hero_4.jpg');" data-aos="fade" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-0"><a href="#">email@domain.com</a></p>
